...
#vars
export home=/app/ips-node/etc/crl-dir/
...
openssl crl -in $home/new/B-TrustTestOperationalQCA.crl -inform DER -text -noout  > $home/new/report3
openssl crl -in $home/new/B-TrustTestOperationalACA.crl -inform DER -text -noout  > $home/new/report4
...
md5sum $old_crl3 >> $home/new/report4
