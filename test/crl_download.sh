...
new_crl1=/app/ips-node/etc/crl-dir/new/B-TrustTestOperationalQCA.crl
new_crl2=/app/ips-node/etc/crl-dir/new/B-TrustTestOperationalACA.crl
old_crl1=/app/ips-node/etc/crl-dir/B-TrustTestOperationalQCA.crl
old_crl2=/app/ips-node/etc/crl-dir/B-TrustTestOperationalACA.crl
#
